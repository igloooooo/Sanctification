            ...
            <ion-footer-bar class="bar-assertive">
                ...
                <div class="tabs-striped tabs-color-assertive" style="position: static; margin-bottom: 15px; width: 100%">
                    <div class="tabs" style="position: static;">
                        ...
                        <a class="tab-item " data-ink-color="#ef473a" data-ink-opacity=".35" ng-click="go('/content/mobileapps/mtmhp/en/home/videohome')">
                            <i class="icon ion-play"></i> Video
                        </a>
                        <a class="tab-item active" data-ink-color="#ef473a" data-ink-opacity=".35" ng-click="go('/content/mobileapps/mtmhp/en/home/setting')">
